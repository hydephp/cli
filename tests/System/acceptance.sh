...
assert_contains "the list separates the CLI's own commands" "$LIST_OUTPUT" "HydeCLI"
assert_contains "the list separates the project's commands" "$LIST_OUTPUT" "Hyde project"
